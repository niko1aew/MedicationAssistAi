...
/// <summary>
/// Сервис для работы с токенами веб-логина из Telegram бота (абстракция в Application Layer)
/// </summary>
public interface IWebLoginTokenService
{
    /// <summary>
    /// Генерировать новый токен веб-логина для пользователя
    /// </summary>
