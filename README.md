...
Информационная система для контроля приема лекарств с безопасной аутентификацией, персонализированным учетом и Telegram ботом.
...
**История изменений:**
- **v1.3 (15.12.2024)** - Добавлен Telegram бот (управление лекарствами, приёмы, напоминания, русский язык)
